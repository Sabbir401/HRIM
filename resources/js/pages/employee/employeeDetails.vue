    ...
    <div class="col-lg-4 col-md-4 col-sm-6 border">
      ...
      <div class="card pi mb-3">
        <div class="card-body p-2">
          <h4 class="text-center text-success">Nominee Information</h4>
          <table
            border="1"
            width="100%"
    ...
    <div class="col-lg-8 col-md-8 col-sm-6">
      <div class="card mb-3">
        <div class="card-body p-2">
          <table border="1" width="100%">
            <tr>
              <th class="p-2 text-center text-success" colspan="4"><h4>Employee Information</h4></th>
            </tr>
            <tr>
      ...
      <div class="card mb-3">
        <div class="card-body p-2">
          ...
          >
            <tr>
              <th class="p-2 text-center text-success" colspan="4"><h4>Official Information</h4></th>
            </tr>
            <tr>
      ...
      <div class="card mb-3">
        <div class="card-body p-2">
          ...
          >
            <tr>
              <th class="p-2 text-center text-success" colspan="4"><h4>Work Experience</h4></th>
            </tr>
            <tr>
      ...
      <div class="card mb-3">
        <div class="card-body p-2">
          ...
          >
            <tr>
              <th class="p-2 text-center text-success" colspan="4"><h4>Training Information</h4></th>
            </tr>
            <tr>
      ...
      <div class="card mb-3">
        <div class="card-body p-2">
          <table border="1" width="100%">
            <tr>
              <th class="p-2 text-center text-success" colspan="6"><h4>Academic Information</h4></th>
            </tr>
            <tr>
